...
public class DomainmodelSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	/**
	 * Enum: 'enum' (ID | 'Int' | 'Real' | 'Bool') '{' EnumOptions '}';
	 */
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     name=ID '{' (ambiguity) (CompareFormula | MyID) ')'? (ConditionOperation '('? (CompareFormula | MyID) ')'?)* '}' (rule end)
	 */
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     name=ID '{' '('? (CompareFormula | MyID) (ambiguity) (ConditionOperation '('? (CompareFormula | MyID) ')'?)* '}' (rule end)
	 */
	...
	/**
	 * Ambiguous syntax:
	 *     Enum | Precondition | Testcase | Run
	 *
	 * This ambiguous syntax occurs at:
